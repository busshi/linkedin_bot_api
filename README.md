...
This bot is the following of [the first one](https://github.com/busshi/linkedin_bot) which used Selenium but for some reasons, I decided to create another one using the API to avoid my raspberry to suffer!
...
- Also available on [Dockerhub](https://hub.docker.com/r/busshi/linkedin_bot_api)
